...
export default function StudentDashboard() {
  ...
  const kpis = [
    { id: "kpi-subjects", label: "Subjects", value: "8" },
    { id: "kpi-attendance", label: "Attendance", value: "94%" },
    { id: "kpi-assignments", label: "Pending", value: "3" },
  ...
  <>
    ...
    <header className="mb-4 sm:mb-12 md:mb-16 lg:mb-20 lg:mb-24">
      <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2">My Campus Hub</h2>
      <p className="text-sm sm:text-base text-slate-600">Access all your academic resources and activities</p>
    </header>
    ...
    >
          ...
          <div className="relative z-10 flex items-center justify-center w-56 h-56 xs:w-72 xs:h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[400px] lg:h-[400px] xl:w-[450px] xl:h-[450px] rounded-full overflow-hidden shadow-2xl mx-auto sm:mx-0 mb-4 sm:mb-0">
            <img src={centerImage || "/placeholder.svg"} alt="Student ERP" className="w-full h-full object-cover" />
          </div>

          {/* Extra Small Mobile (320px-475px) - 3x3 grid */}
          ...
          {/* Small Mobile (475px-640px) - 3x3 grid larger */}
          ...
          {/* Tablet (640px-768px) - Compact Radial Layout */}
          ...
          {/* Desktop Small (768px-1024px) - Two-ring Radial Layout */}
          ...
          {/* Desktop Large (1024px+) - Two-ring Radial Layout */}
