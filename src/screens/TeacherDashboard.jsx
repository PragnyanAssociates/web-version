...
const allQuickAccessItems = [
  ...
  },
  {
    ...
    navigateTo: "/TeacherSyllabusScreen",
  },
  {
    id: "qa7",
    title: "Exam Schedule",
...
export default function TeacherDashboard() {
  ...
  const kpis = [
    ...
    { id: "kpi-students", label: "Students", value: "180" },
    { id: "kpi-subjects", label: "Subjects", value: "3" },
    { id: "kpi-attendance", label: "Avg. Attendance", value: "92%" },
  ]
  ...
  <>
    ...
    <header className="mb-4 sm:mb-12 md:mb-16 lg:mb-20 lg:mb-24">
      <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2">Teacher Management System</h2>
      <p className="text-sm sm:text-base text-slate-600">Access all teaching tools and resources</p>
    </header>
    ...
    <div className="flex flex-wrap items-center justify-between gap-y-3 gap-x-4">
      ...
      <div className="w-full sm:w-auto sm:min-w-0 sm:flex-1">
        ...
        <p className="text-xs sm:text-sm text-slate-600 mb-0">
          ERP for Educational Professionals
        </p>
      </div>
