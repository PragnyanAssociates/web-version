...
// Colors used (4 total) - EXACT SAME AS ADMIN DASHBOARD:
// - Primary: blue-600
// - Neutrals: white, slate-900 (text), slate-600 (muted), slate-200 (borders)
...
const allQuickAccessItems = [
  ...
  },
  {
    ...
    navigateTo: "/DonorSuggestionsScreen",
  },
  {
    id: "qa5",
    title: "Help Desk",
    imageSource: "https://cdn-icons-png.flaticon.com/128/4961/4961736.png",
    navigateTo: "/DonorHelpDeskScreen",
  },
  {
    id: "qa6",
    title: "Sponsorship",
    imageSource: "https://cdn-icons-png.flaticon.com/128/18835/18835518.png",
    navigateTo: "/DonorSponsorScreen",
  },
  {
    id: "qa7",
    title: "About Us",
    imageSource: "https://cdn-icons-png.flaticon.com/128/3815/3815523.png",
    navigateTo: "/AboutUs",
  },
]
...
export default function ParentDashboard() {
      ...
      try {
        ...
        if (res.ok) {
          ...
          setProfile({
            ...
            full_name: user.full_name || "Parent",
  ...
  // Simple KPI placeholders for parent/donor
  // Mixed parent-focused KPIs
  // Alternative comprehensive parent KPIs
  const kpis = [
    { id: "kpi-attendance", label: "Attendance", value: "94%" }, // Child's attendance rate
    { id: "kpi-grades", label: "Overall Grade", value: "A-" }, // Child's current grade average
    { id: "kpi-pending", label: "Pending Tasks", value: "3" }, // Homework/assignments pending
    { id: "kpi-fees", label: "Next Fee Due", value: "Jan 15" }, // Next fee payment date
  ]

  let mainContent
  if (activeTab === "calendar") {
    mainContent = (
      <section aria-label="Academic Calendar" className="rounded-xl border border-slate-200 bg-white p-3 sm:p-6">
        <AcademicCalendar />
      </section>
    )
    ...
    mainContent = (
      <section
        aria-label="Profile"
        className="rounded-xl border border-slate-200 bg-white p-6 sm:p-8 lg:p-10 flex flex-col items-center text-center"
      >
        <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
          <UserIcon />
        </div>
        <h2 className="text-lg sm:text-xl font-semibold text-slate-900 mb-1">Profile coming soon</h2>
        <p className="text-sm text-slate-600">We're preparing your profile experience.</p>
      </section>
    )
  } else {
    mainContent = (
      <>
        {/* Modules with Central School ERP Image */}
        <header className="mb-12 sm:mb-16 md:mb-20 lg:mb-24 text-left">
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2">Parent Engagement System</h2>
          <p className="text-sm sm:text-base text-slate-600">Stay connected with your child's education journey</p>
        </header>

      <section
  aria-label="Quick access"
  className="relative block sm:flex sm:items-center sm:justify-center min-h-[480px] xs:min-h-[500px] sm:min-h-[640px] md:min-h-[750px] lg:min-h-[820px] xl:min-h-[940px] pt-0 -mt-28 pb-6 sm:pb-8 md:pb-12"


>
          {/* Central School ERP Image */}
          <div
          ...
          {/* Extra Small Mobile (320px-475px) - 2-column cards for readability */}
          <div className="xs:hidden w-full mt-4 flex items-center justify-center">
            <div className="grid grid-cols-2 gap-4 w-full max-w-sm px-2 pr-6">
          ...
          {/* Small Mobile (475px-640px) - 2-column larger cards for readability */}
          <div className="hidden xs:block sm:hidden w-full mt-5 flex items-center justify-center">
            <div className="grid grid-cols-2 gap-5 w-full max-w-sm px-3 pr-8">
          ...
          {/* Tablet (640px-768px) - Compact Radial Layout with larger radius */}
          ...
          {/* Desktop Small (768px-1024px) - Single ring layout since fewer items */}
          ...
          {/* Desktop Large (1024px+) - Single ring layout with larger modules */}
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-0 sm:py-0.5 lg:py-1">
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs sm:text-sm text-slate-600 mb-0">ERP for Educational Partners</p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-32 sm:w-44 lg:w-64 rounded-md border border-slate-200 bg-white px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="inline-flex items-stretch rounded-lg border border-slate-200 bg-white overflow-hidden">
                <button
                  ...
                  className={`flex items-center gap-1 px-2 sm:px-3 py-1.5 text-xs sm:text-sm transition ${
                    activeTab === "home" ? "bg-blue-600 text-white" : "text-slate-700 hover:bg-slate-50"
                  }`}
                ...
                <button
                  ...
                  className={`flex items-center gap-1 px-2 sm:px-3 py-1.5 text-xs sm:text-sm transition ${
                    activeTab === "calendar" ? "bg-blue-600 text-white" : "text-slate-700 hover:bg-slate-50"
                  }`}
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="hidden sm:flex flex-col">
                  ...
                  <span className="text-xs text-slate-600 capitalize">Parent</span>
                </div>
                <button
          ...
          {/* KPIs */}
          <section className="mt-3 pt-3 border-t border-slate-200" aria-label="Key metrics">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
              {kpis.map((kpi) => (
                <div
                  key={kpi.id}
                  className="flex flex-col items-center rounded-lg border border-slate-200 bg-white p-1 sm:p-1"
                >
